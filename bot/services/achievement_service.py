...
ACHIEVEMENTS: dict[str, tuple[str, str, str]] = {
    ...
    "generous_partner": ("🛍️", "Щедрый партнёр", "Подарили первый подарок партнёру"),
    "handyman": ("🧰", "Мастер на все руки", "7 подработок подряд без пропусков"),
    "workaholic": ("🔥", "Трудоголик", "21 день подряд ходили на работу"),
    "generous_soul": ("🤝", "Щедрая душа", "Перевели деньги другому игроку впервые"),
}
