...
CATEGORIES = {
    "work": {
        ...
        "commands": [
            ...
            ("/gig", "Подработка дня (раз в сутки)"),
            ("/balance", "Посмотреть баланс"),
            ("/pay", "Перевести монеты другому игроку"),
    ...
    "relationships": {
        ...
        "commands": [
            ...
            ("/surprise", "Отправить анонимный сюрприз партнёру"),
            ("/gift", "Подарить подарок партнёру"),
        ],
    },
    "family": {
        "label": "🏠 Семья",
    ...
    "children": {
        ...
        "commands": [
            ...
            ("/kindergarten", "Отдать ребёнка в сад / забрать домой"),
        ],
    },
    "pets": {
        "label": "🐾 Питомец",
        "commands": [
            ("/petshop", "Завести питомца"),
            ("/pet", "Карточка питомца"),
            ("/name_pet", "Переименовать питомца"),
            ("/pet_actions", "Взаимодействовать с питомцем"),
        ],
    },
    "leaderboard": {
        "label": "🏆 Рейтинг",
        "commands": [
            ("/top", "Рейтинг пар в этой беседе"),
